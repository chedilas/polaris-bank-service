...
class CreatePolarisTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('polaris_bank_transactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('polaris_transactions');
    }
}
