...
use GloCurrency\PolarisBank\Database\Factories\SenderFactory;
use BrokeYourBike\PolarisBank\Interfaces\SenderInterface;
use BrokeYourBike\CountryCasts\Alpha2Cast;
use BrokeYourBike\BaseModels\BaseUuid;

/**
 * GloCurrency\PolarisBank\Models\Sender
 *
 * @property string $id
...
class Sender extends BaseUuid implements SenderInterface
{
    ...
    protected $table = 'polaris_bank_senders';
