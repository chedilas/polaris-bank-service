...
namespace GloCurrency\PolarisBank\Jobs;
...
use GloCurrency\PolarisBank\Helpers\SenderFactory;
use GloCurrency\PolarisBank\Helpers\RecipientFactory;
use GloCurrency\PolarisBank\Exceptions\CreateTransactionException;
...
class CreateTransactionJob implements ShouldQueue, ShouldBeUnique, ShouldBeEncrypted
{
    ...
    public function handle()
    {
        ...
        Transaction::create([
            ...
            'polaris_bank_sender_id' => $targetSender->id,
            'polaris_bank_recipient_id' => $targetRecipient->id,
